<nav class="bg-white fixed w-full z-20 top-0 start-0 border-b border-gray-200 ">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <span class="self-center text-2xl font-semibold whitespace-nowrap">Zidan Transport</span>
        </a>
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            <div class="flex items-center space-x-6 rtl:space-x-reverse">
                <a href="tel:5541251234" class="text-sm text-gray-500 hover:underline">+62 821 4295 1682</a>
                
                <!-- Jika pengguna login, tampilkan nama mereka -->
                @auth
                    <div class="flex items-center space-x-3 rtl:space-x-reverse">
                        <span class="text-sm text-gray-900 font-medium">{{ Auth::user()->name }}</span>
